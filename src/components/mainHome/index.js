...
import capot from './../../assets/images/capot.png'
           ...
           <h1 className={Style.AutoType}>القطع الكهربائية</h1>
            ...
            <div className={Style.cardImageDiv}>
              <div className={Style.waterMark} >
                <img className={Style.LogoMark}src={logo}/>
                </div>
...
<h3 className={Style.hover}>عرض المزيد</h3>
 ...
 <div onClick={event  => Scroll("micanic" , "left")}  className={Style.ProdectsArrows}>
<svg  version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_left</title>
<path d="M20.563 22.104l-1.875 1.875-8-8 8-8 1.875 1.875-6.125 6.125z"></path>
</svg>
</div>
<div onClick={event  => Scroll("micanic" , "right")}  className={Style.ProdectsArrows}>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_right</title>
<path d="M11.438 22.479l6.125-6.125-6.125-6.125 1.875-1.875 8 8-8 8z"></path>
</svg>
...
<h1 className={Style.AutoType}>القطع الميكانيكية</h1>
</div>
 <div className="hl"></div>
 <div className={`${Style.ProdectsCards}`} >
 <div className={`row cards ${Style.gap}`}  id="micanic" dir="rtl">
 <div className={Style.card} dir="ltr">
   <div className={Style.genuen}>
     <span>أصلي</span>
   </div>
 <div className={Style.cardImageDiv}>
   ...
   <img className={Style.prodectsImage}  src={tros}/>
 </div>
 <div className={Style.topCard}>
 <div className="card-button">
<svg className="svg-icon" viewBox="0 0 20 20">
...
<path d="M13.972,12.386c-1.022,0-1.855,0.834-1.855,1.856s0.833,1.853,1.855,1.853s1.854-0.83,1.854-1.853S14.994,12.386,13.972,12.386z M13.972,15.116c-0.484,0-0.878-0.393-0.878-0.874c0-0.484,0.394-0.878,0.878-0.878c0.482,0,0.875,0.394,0.875,0.878C14.847,14.724,14.454,15.116,13.972,15.116z"></path>
 ...
 <h2 className={Style.ProdectsName}>علبة تروس</h2>
...
<h3 className={Style.hover}>عرض المزيد</h3>
 ...
 <div onClick={event  => Scroll("body" , "left")}  className={Style.ProdectsArrows}>
<svg  version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_left</title>
<path d="M20.563 22.104l-1.875 1.875-8-8 8-8 1.875 1.875-6.125 6.125z"></path>
</svg>
</div>
<div onClick={event  => Scroll("body" , "right")}  className={Style.ProdectsArrows}>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_right</title>
<path d="M11.438 22.479l6.125-6.125-6.125-6.125 1.875-1.875 8 8-8 8z"></path>
</svg>
...
<h1 className={Style.AutoType}>القطع الخارجية | بودي</h1>
</div>
 <div className="hl"></div>
 <div className={`${Style.ProdectsCards}`} >
 <div className={`row cards ${Style.gap}`}  id="body" dir="rtl">
 <div className={Style.card} dir="ltr">
   <div className={Style.genuen}>
     <span>أصلي</span>
   </div>
 <div className={Style.cardImageDiv}>
   ...
   <img className={Style.prodectsImage}  src={capot}/>
 </div>
 <div className={Style.topCard}>
 <div className="card-button">
<svg className="svg-icon" viewBox="0 0 20 20">
...
<path d="M13.972,12.386c-1.022,0-1.855,0.834-1.855,1.856s0.833,1.853,1.855,1.853s1.854-0.83,1.854-1.853S14.994,12.386,13.972,12.386z M13.972,15.116c-0.484,0-0.878-0.393-0.878-0.874c0-0.484,0.394-0.878,0.878-0.878c0.482,0,0.875,0.394,0.875,0.878C14.847,14.724,14.454,15.116,13.972,15.116z"></path>
 ...
 <h2 className={Style.ProdectsName}>كبوت</h2>
...
<h3 className={Style.hover}>عرض المزيد</h3>
 ...
 <div onClick={event  => Scroll("dicor" , "left")}  className={Style.ProdectsArrows}>
<svg  version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_left</title>
<path d="M20.563 22.104l-1.875 1.875-8-8 8-8 1.875 1.875-6.125 6.125z"></path>
</svg>
</div>
<div onClick={event  => Scroll("dicor" , "right")}  className={Style.ProdectsArrows}>
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 32 32">
<title>keyboard_arrow_right</title>
<path d="M11.438 22.479l6.125-6.125-6.125-6.125 1.875-1.875 8 8-8 8z"></path>
</svg>
...
<h1 className={Style.AutoType}>الديكور</h1>
</div>
 <div className="hl"></div>
 <div className={`${Style.ProdectsCards}`} >
 <div className={`row cards ${Style.gap}`}  id="dicor" dir="rtl">
 <div className={Style.card} dir="ltr">
   <div className={Style.genuen}>
     <span>أصلي</span>
   </div>
 <div className={Style.cardImageDiv}>
   ...
   <img className={Style.prodectsImage}  src={handler}/>
 </div>
 <div className={Style.topCard}>
 <div className="card-button">
<svg className="svg-icon" viewBox="0 0 20 20">
...
<path d="M13.972,12.386c-1.022,0-1.855,0.834-1.855,1.856s0.833,1.853,1.855,1.853s1.854-0.83,1.854-1.853S14.994,12.386,13.972,12.386z M13.972,15.116c-0.484,0-0.878-0.393-0.878-0.874c0-0.484,0.394-0.878,0.878-0.878c0.482,0,0.875,0.394,0.875,0.878C14.847,14.724,14.454,15.116,13.972,15.116z"></path>
 ...
 <h2 className={Style.ProdectsName}>مقبض باب</h2>
